...
def get_question():
    ...
    with st.spinner("Le quiz est en cours de création"):
        response = model.generate_content(f"Crée un QCM d'une question de niveau {level} et de matière {subject}, avec 4 réponses pour une réponse correcte. La réponse doit etre en format text decodable par JSON comme un container JSON avec : question, choices, correct_answer, explanation ")
